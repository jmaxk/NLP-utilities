package max.nlp.wsd.w2vec.util;
...
public class WordKmeans {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vec.loadGoogleModel("/home/jmaxk/temp/fb/data/currentLoc/vecs/TX.bin");
        System.out.println("load model ok!");
        WordKmeans wordKmeans = new WordKmeans(vec.getWordMap(), 200, 50);
